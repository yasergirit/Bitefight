<ul id="menuHead">
	@if(\Illuminate\Support\Facades\Request::is('install'))
		<li class="active"><a href="{{url('/install')}}" target="_top">Install</a></li>
	@else
		...
		@else
			...
			<li id="premium" class="{{(\Illuminate\Support\Facades\Request::is('voodoo')) ? 'active' : ''}}">
				<img border="0" src="{{asset('img/night-stamp/sigil-currency.svg')}}">
